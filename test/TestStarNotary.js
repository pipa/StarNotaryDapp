...
it('can add the star name and star symbol properly', async() => {
    ...
    await instance.createStar('awesome star', 6, {
        from: accounts[1]
    });
    ...
    assert.equal(name, 'NStar Notary System');
    assert.equal(symbol, 'NINI');
});
...
it('lets 2 users exchange stars', async() => {
    ...
    await instance.createStar('cool star 2', starId2, {from: user2});
...
it('lookUptokenIdToStarInfo test', async() => {
    ...
    assert.equal(_starName, starName);
});